...
const Contact: React.FC = () => {
  const [state, handleSubmit] = useForm("meeeradq");
            ...
            <div className="relative">
              ...
              <div className="relative p-8 sm:p-12 glass rounded-[2.5rem] border border-white/10 shadow-2xl">
                <div className="text-center py-12 space-y-4 animate-in fade-in zoom-in">
                  ...
                  <button onClick={() => window.location.reload()} className="text-accent-500 font-bold hover:underline">Envoyer un autre message</button>
                </div>
              </div>
            </div>
          </div>
